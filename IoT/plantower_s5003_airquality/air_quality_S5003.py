...
class S5003AirQuality():
    ...
    def connect_to_sensor(self, mode: str):
        ...
        try:
            ...
            self.logger.info('Connected to Plantower S5003')

        except Exception as e:
            self.logger.debug(f"Failed to connect to Plantower S5003 {e}... sleeping for 1/2 hour")  # noqa: E501
            sleep(1800)  # sleep for 1/2 hour
    ...
    def get_air_quality(self):
        ...
        try:
            air_data = self.plantower_s5003.read(32)
