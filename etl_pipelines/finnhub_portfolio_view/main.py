...
def parse_data(data: dict, symbol: str) -> dict:

    return finn_util.parse_stock_data_portfolio(data, symbol)
...
def write_data(data: dict):
    ...
    MEASUREMENT = os.environ['PORTFOLIO_MEASUREMENT']
...
def main():
    ...
    if validate_json_payload(stock_data) == 0:
        ...
        stock_payload = parse_data(stock_data, STOCK_SYMBOL)
