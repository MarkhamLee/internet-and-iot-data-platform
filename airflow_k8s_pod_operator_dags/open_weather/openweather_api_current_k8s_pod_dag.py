...
# uses to run the container that does.
...
with DAG(
    ...
    k = KubernetesPodOperator(
        ...
        image="markhamlee/openweather_current:arm64",
        env_vars=env_variables,
        env_from=configmaps,
        secrets=[secret_env1, secret_env2, secret_env3],
        cmds=["python3"],
        arguments=["main.py"],
        name="openweather_current_pod",
        task_id="openweather_current_data",
